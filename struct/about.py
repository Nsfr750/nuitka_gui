...
This module provides the About dialog for the Nuitka GUI Compiler application.
Displays version, copyright, and a brief description to the user.
"""
...
class About:
    """
    A class to display the About dialog.
